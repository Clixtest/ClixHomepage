                ...
                <div className='hero '>
                    ...
                    <div className="hero-content p-0 max-w-none flex-col md:flex-col-reverse lg:flex-col-reverse xl:flex-row-reverse 2xl:flex-row-reverse 3xl:flex-row-reverse 2xl:gap-32">
                        <div className=' text-white'>
                            ...
                            <Link to="" className="py-[8px] mt-10 hover:bg-[#079E01] rounded-3xl w-40 flex justify-center items-center bg-[#079E01]">Know More <span className=' mt-1 ml-2'><img src={Icon} alt='' /></span></Link>
                        </div>
